...
CountdownTimer.prototype = {
    ...
    countDown: function () {
        ...
        var me = this;
        let userDate = document.querySelector('.counter__date').innerHTML;

        let userTime = document.querySelector('.counter__time').innerHTML;
...
function CDT() {
    ...
    // Set countdown limit
    var tl = new Date('2019/10/05 23: 00: 00');
